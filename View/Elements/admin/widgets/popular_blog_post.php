...
<?php
echo $this->BcForm->input($key . '.order', array(
	'type'		 => 'select',
...
<?php
echo $this->BcForm->input($key . '.blog_content_id', array(
	'type'		 => 'select',
...
?>
<br />
<?php echo $this->BcForm->input($key . '.restrict_archive_category', array('type' => 'checkbox', 'label' => '表示中のカテゴリーアーカイブ内の記事でランキング表示を行う')) ?>