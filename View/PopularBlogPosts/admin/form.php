...
<table cellpadding="0" cellspacing="0" class="form-table section">
	...
	<tr>
		...
		<td class="col-input">
			<?php echo $this->BcForm->input('PopularBlogPost.view_count', array(
				'type' => 'text', 'size' => 20,
...
<?php else: ?>
	...
	<?php $this->BcBaser->link('削除',
		array('action' => 'delete', $this->BcForm->value('PopularBlogPost.id')),
		array('class' => 'btn-gray button'),
		sprintf('ID：%s のデータを削除して良いですか？', $this->BcForm->value('PopularBlogPost.id')),
		false); ?>
<?php endif ?>
</div>
